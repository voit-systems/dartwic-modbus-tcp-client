(() => {
  ...
  function createModuleUiPlugin(host) {
    ...
    function ModbusModuleConfigPage({ instanceConfig, setInstanceConfig, save, moduleConfig = {} }) {
      ...
      return /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex h-fit w-fit flex-row items-center gap-5 rounded-lg border border-border p-2" }, moduleConfig.icon_image_src ? /* @__PURE__ */ React.createElement("img", { className: "h-[30px]", src: moduleConfig.icon_image_src }) : null, /* @__PURE__ */ React.createElement(Label, { className: "text-lg" }, moduleConfig.title || "Modbus TCP Client")), /* @__PURE__ */ React.createElement("div", { className: "flex h-fit w-fit flex-row justify-center gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-row items-center gap-5 rounded-lg border border-border p-2" }, /* @__PURE__ */ React.createElement(Label, null, instanceConfig?.name || "")), /* @__PURE__ */ React.createElement(Button, { variant: "outline", disabled: !isDirty || isSaving, onClick: handleSave }, isSaving ? "SAVING" : "SAVE CONFIG")), /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-3 rounded-lg border border-border p-4" }, /* @__PURE__ */ React.createElement(Label, { className: "text-md font-semibold" }, "Connection"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-1" }, /* @__PURE__ */ React.createElement(Label, null, "Server IP"), /* @__PURE__ */ React.createElement(
        Input,
        {
